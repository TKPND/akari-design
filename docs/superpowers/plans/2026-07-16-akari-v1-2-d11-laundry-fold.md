# Akari v1.2 Daily.3 D11 Implementation Plan

**Goal:** Build, select, promote, verify, and integrate the first Wave 3 life
action: folding laundry on the rug.

## Tasks

1. Add failing D11 asset, generation, dependency, count, script, and lifecycle
   tests.
2. Register the D11 r01 manifest, validator policy, A/B comparison command, and
