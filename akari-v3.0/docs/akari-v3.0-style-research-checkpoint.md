...
Status: D-series rejected; an external-model V2.3 face candidate is awaiting a reproducibility gate
...
この6枚はまだ生成していない。1枚目も正式な顔アンカーへ昇格しておらず、
生成画像をGitへ追加しない境界も維持する。
